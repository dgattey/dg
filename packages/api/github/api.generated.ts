...
export type AddBlockedByInput = {
  ...
  readonly blockingIssueId: Scalars['ID']['input'];
  /** A unique identifier for the client performing the mutation. */
  readonly clientMutationId: InputMaybe<Scalars['String']['input']>;
...
export type AddSubIssueInput = {
  ...
  readonly subIssueId: InputMaybe<Scalars['ID']['input']>;
  /** The url of the sub-issue. */
  readonly subIssueUrl: InputMaybe<Scalars['String']['input']>;
};
...
export type CloseIssueInput = {
  ...
  readonly duplicateIssueId: InputMaybe<Scalars['ID']['input']>;
...
export type CodeScanningParametersInput = {
  ...
  readonly codeScanningTools: ReadonlyArray<CodeScanningToolInput>;
};
...
export type CopilotCodeReviewParametersInput = {
  ...
  readonly reviewDraftPullRequests: InputMaybe<Scalars['Boolean']['input']>;
  /** Copilot automatically reviews each new push to the pull request. */
  readonly reviewOnPush: InputMaybe<Scalars['Boolean']['input']>;
};
...
export type CreateIssueTypeInput = {
  ...
  readonly color: InputMaybe<IssueTypeColor>;
...
export type CreateProjectV2FieldInput = {
  ...
  readonly iterationConfiguration: InputMaybe<ProjectV2IterationFieldConfigurationInput>;
...
export type CreateProjectV2StatusUpdateInput = {
  ...
  readonly status: InputMaybe<ProjectV2StatusUpdateStatus>;
  /** The target date of the status update. */
  readonly targetDate: InputMaybe<Scalars['Date']['input']>;
};
...
export type CreateSponsorshipsInput = {
  ...
  readonly recurring: InputMaybe<Scalars['Boolean']['input']>;
...
export type DeclineTopicSuggestionInput = {
   ...
   *
   */
  readonly reason: InputMaybe<TopicSuggestionDeclineReason>;
  /**
   * The Node ID of the repository.
   *
   * **Upcoming Change on 2024-04-01 UTC**
...
export type DeleteIssueTypeInput = {
  ...
  readonly issueTypeId: Scalars['ID']['input'];
};
...
export type DeleteProjectV2StatusUpdateInput = {
  ...
  readonly statusUpdateId: Scalars['ID']['input'];
};
...
export type DeleteUserListInput = {
  ...
  readonly listId: Scalars['ID']['input'];
};
...
export type EnterpriseMemberInvitationOrder = {
  ...
  readonly field: EnterpriseMemberInvitationOrderField;
};
...
export type FileExtensionRestrictionParametersInput = {
  ...
  readonly restrictedFileExtensions: ReadonlyArray<Scalars['String']['input']>;
};

/** Prevent commits that include changes in specified file and folder paths from being pushed to the commit graph. This includes absolute paths that contain file names. */
export type FilePathRestrictionParametersInput = {
  /** The file paths that are restricted from being pushed to the commit graph. */
  readonly restrictedFilePaths: ReadonlyArray<Scalars['String']['input']>;
};
...
export type IssueDependencyOrder = {
  ...
  readonly field: IssueDependencyOrderField;
};
...
export type IssueTypeOrder = {
  ...
  readonly field: IssueTypeOrderField;
};
...
export type MaxFilePathLengthParametersInput = {
  ...
  readonly maxFilePathLength: Scalars['Int']['input'];
};

/** Prevent commits with individual files that exceed the specified limit from being pushed to the commit graph. */
export type MaxFileSizeParametersInput = {
  /** The maximum file size allowed in megabytes. This limit does not apply to Git Large File Storage (Git LFS). */
  readonly maxFileSize: Scalars['Int']['input'];
};
...
export type MergeQueueParametersInput = {
  ...
  readonly checkResponseTimeoutMinutes: Scalars['Int']['input'];
  /** When set to ALLGREEN, the merge commit created by merge queue for each PR in the group must pass all required checks to merge. When set to HEADGREEN, only the commit at the head of the merge group, i.e. the commit containing changes from all of the PRs in the group, must pass its required checks to merge. */
  readonly groupingStrategy: MergeQueueGroupingStrategy;
  /** Limit the number of queued pull requests requesting checks and workflow runs at the same time. */
  readonly maxEntriesToBuild: Scalars['Int']['input'];
  /** The maximum number of PRs that will be merged together in a group. */
  readonly maxEntriesToMerge: Scalars['Int']['input'];
  /** Method to use when merging changes from queued pull requests. */
  readonly mergeMethod: MergeQueueMergeMethod;
  /** The minimum number of PRs that will be merged together in a group. */
  readonly minEntriesToMerge: Scalars['Int']['input'];
  /** The time merge queue should wait after the first PR is added to the queue for the minimum group size to be met. After this time has elapsed, the minimum group size will be ignored and a smaller group will be merged. */
  readonly minEntriesToMergeWaitMinutes: Scalars['Int']['input'];
};
...
export type PinnedEnvironmentOrder = {
  ...
  readonly field: PinnedEnvironmentOrderField;
};
...
export type ProjectV2IterationFieldConfigurationInput = {
  ...
  readonly iterations: ReadonlyArray<ProjectV2Iteration>;
...
export type ProjectV2StatusOrder = {
  ...
  readonly field: ProjectV2StatusUpdateOrderField;
};
...
export type PropertyTargetDefinitionInput = {
  ...
  readonly propertyValues: ReadonlyArray<Scalars['String']['input']>;
...
export type PullRequestParametersInput = {
  /** Array of allowed merge methods. Allowed values include `merge`, `squash`, and `rebase`. At least one option must be enabled. */
  readonly allowedMergeMethods: InputMaybe<ReadonlyArray<PullRequestAllowedMergeMethods>>;
  /** Request Copilot code review for new pull requests automatically if the author has access to Copilot code review. */
  readonly automaticCopilotCodeReviewEnabled: InputMaybe<Scalars['Boolean']['input']>;
...
export type RemoveSubIssueInput = {
  ...
  readonly issueId: Scalars['ID']['input'];
  /** The id of the sub-issue. */
  readonly subIssueId: Scalars['ID']['input'];
};
...
export type ReplaceActorsForAssignableInput = {
  ...
  readonly actorIds: ReadonlyArray<Scalars['ID']['input']>;
...
export type RepositoryPropertyConditionTargetInput = {
  ...
  readonly exclude: ReadonlyArray<PropertyTargetDefinitionInput>;
  /** Array of repository properties that must match */
  readonly include: ReadonlyArray<PropertyTargetDefinitionInput>;
};
...
export type RepositoryRuleConditionsInput = {
  ...
  readonly repositoryProperty: InputMaybe<RepositoryPropertyConditionTargetInput>;
};
...
export type RepositoryRuleOrder = {
  ...
  readonly field: RepositoryRuleOrderField;
};
...
export type RepositoryRulesetBypassActorInput = {
  ...
  readonly deployKey: InputMaybe<Scalars['Boolean']['input']>;
  /** For enterprise owner bypasses, true */
  readonly enterpriseOwner: InputMaybe<Scalars['Boolean']['input']>;
...
export type RequestReviewsInput = {
  ...
  readonly botIds: InputMaybe<ReadonlyArray<Scalars['ID']['input']>>;
  /** A unique identifier for the client performing the mutation. */
  readonly clientMutationId: InputMaybe<Scalars['String']['input']>;
  /** The Node ID of the pull request to modify. */
  readonly pullRequestId: Scalars['ID']['input'];
...
export type RequiredStatusChecksParametersInput = {
  ...
  readonly doNotEnforceOnCreate: InputMaybe<Scalars['Boolean']['input']>;
...
export type RuleParametersInput = {
  ...
  readonly codeScanning: InputMaybe<CodeScanningParametersInput>;
  ...
  readonly copilotCodeReview: InputMaybe<CopilotCodeReviewParametersInput>;
  /** Parameters used for the `file_extension_restriction` rule type */
  readonly fileExtensionRestriction: InputMaybe<FileExtensionRestrictionParametersInput>;
  /** Parameters used for the `file_path_restriction` rule type */
  readonly filePathRestriction: InputMaybe<FilePathRestrictionParametersInput>;
  /** Parameters used for the `max_file_path_length` rule type */
  readonly maxFilePathLength: InputMaybe<MaxFilePathLengthParametersInput>;
  /** Parameters used for the `max_file_size` rule type */
  readonly maxFileSize: InputMaybe<MaxFileSizeParametersInput>;
  /** Parameters used for the `merge_queue` rule type */
  readonly mergeQueue: InputMaybe<MergeQueueParametersInput>;
...
export type SponsorAndLifetimeValueOrder = {
  ...
  readonly field: SponsorAndLifetimeValueOrderField;
};
...
export type StartRepositoryMigrationInput = {
  ...
  readonly sourceRepositoryUrl: Scalars['URI']['input'];
...
export type UpdateEnterpriseProfileInput = {
  ...
  readonly securityContactEmail: InputMaybe<Scalars['String']['input']>;
...
export type UpdateEnterpriseTwoFactorAuthenticationDisallowedMethodsSettingInput = {
  ...
  readonly settingValue: EnterpriseDisallowedMethodsSettingValue;
};
...
export type UpdatePatreonSponsorabilityInput = {
  ...
  readonly enablePatreonSponsorships: Scalars['Boolean']['input'];
...
export type UpdateRepositoryInput = {
  ...
  readonly hasSponsorshipsEnabled: InputMaybe<Scalars['Boolean']['input']>;
  /** Indicates if the repository should have the wiki feature enabled. */
  readonly hasWikiEnabled: InputMaybe<Scalars['Boolean']['input']>;
...
export type UpdateTeamReviewAssignmentInput = {
  ...
  readonly countMembersAlreadyRequested: InputMaybe<Scalars['Boolean']['input']>;
  ...
  readonly includeChildTeamMembers: InputMaybe<Scalars['Boolean']['input']>;
  /** Notify the entire team of the PR if it is delegated */
  readonly notifyTeam: InputMaybe<Scalars['Boolean']['input']>;
  /** Remove the team review request when assigning */
  readonly removeTeamRequest: InputMaybe<Scalars['Boolean']['input']>;
...
export type UpdateUserListsForItemInput = {
  ...
  readonly listIds: ReadonlyArray<Scalars['ID']['input']>;
  /** The suggested lists to create and add this item to */
  readonly suggestedListIds: InputMaybe<ReadonlyArray<Scalars['ID']['input']>>;
};
