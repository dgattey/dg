...
export type DgRepoLatestReleaseQueryVariables = Exact<{ [key: string]: never; }>;


export type DgRepoLatestReleaseQuery = { readonly repository: { readonly latestRelease: { readonly name: string | undefined } | undefined } | undefined };
